...
submit.classList.add("submit","slide-in");
submit.textContent="submit";

//rating user chose, displayed in feedback message
...
ratings.forEach(element=>{
    element.addEventListener("click",()=>{
       ...
       element.classList.add('chosen-rating');
        ...
        rate_span.textContent=rate_val;
      ...
      submit_state_container.classList.add("slide-in");
      submit_state_container.style.display="flex";
...
submit.addEventListener("click",()=>{
    submit_state_container.style.display="none";
    feedback_state_container.classList.add("slide-in");
    feedback_state_container.style.display="flex";
